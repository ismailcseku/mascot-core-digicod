...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style5', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/counter-block/counter-block-style5' . $direction_suffix . '.css' );
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'counter-skin-style5', null, 'counter-block/tpl', $settings, true );
