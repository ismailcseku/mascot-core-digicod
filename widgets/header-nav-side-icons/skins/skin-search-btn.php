...
class Skin_Search_Btn extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Search Button', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'search_btn_options',
			[
				'label' => esc_html__( 'Search Icon Options', 'mascot-core-digicod' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Icon Typography', 'mascot-core-digicod' ),
