<div class="woocommerce top-nav-mini-cart-icon-container">
	<div class="top-nav-mini-cart-icon-contents">
		<a class="mini-cart-icon" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'mascot-core-digicod' ); ?>"><i class="<?php echo mascot_core_get_redux_option( 'header-settings-navigation-menu-cart-icon-code', 'fa fa-shopping-cart' ); ?>"></i>
			<?php if(WC()->cart){?>
