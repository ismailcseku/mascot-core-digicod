...
<div id="<?php echo esc_attr($holder_id)?>" class="side-panel-container <?php echo esc_attr(implode(' ', $classes)); ?>">
	<div class="side-panel-wrap">
		...
		<p><?php echo sprintf( esc_html__( 'Step 2: Goto %1$sTheme Options > Side Push Panel Sidebar%2$s and select it from the dropdown menu.', 'mascot-core-digicod' ), '<strong>', '</strong>')?></p>
