	...
	<?php
		...
		while ( $the_query->have_posts() ) :
			...
			$term_list = wp_get_post_terms(get_the_ID(), 'give_forms_category', array("fields" => "all"));
			if ( !empty ( $term_list) ) {
	...
	<div class="isotope-layout-filter <?php echo esc_attr( $cat_filter_style );?>" data-link-with="<?php echo esc_attr( $holder_id ) ?>">
		<a href="#" class="active" data-filter="*"><?php echo apply_filters( 'mascot_core_isotope_carousel_filter_all_text', esc_html__( 'All', 'mascot-core-digicod')); ?></a>
