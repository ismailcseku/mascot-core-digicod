...
class Skin_Forms_CurrentTheme_Horizontal extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-forms-current-theme-horizontal';
	}


	public function get_title() {
		return __( 'Give Forms Current Theme Horizontal', 'mascot-core-digicod' );
	}
