<?php
namespace MascotCoreDigicod\Widgets\MovingText;
...
class TM_Elementor_MovingText extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Moving Text - Digicod', 'mascot-core-digicod' );
	}
	...
	protected function register_content_tab() {
		$mascot_shape = [];
		$mascot_shape['mascot_wave'] = esc_html__( 'Mascot Wave', 'mascot-core-digicod' );
		$mascot_shape['mascot_line_simple'] = esc_html__( 'Mascot Line', 'mascot-core-digicod' );

		$this->start_controls_section(
			'general',
			[
				'label' => esc_html__( 'Moving Text', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				...
				'rows' => 3,
				'label_block' => true,
				'default' => esc_html__( 'Sample Moving Text', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'path',
			[
				'label' => esc_html__( 'Path Type', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'custom_path',
			[
				'label' => esc_html__( 'SVG', 'mascot-core-digicod' ),
				...
				'description' => sprintf( esc_html__( 'Want to create custom text paths with SVG?' , 'mascot-core-digicod' ).' <a target="_blank" href="%s">Learn More</a>', 'https://go.elementor.com/text-path-create-paths' ),
			]
		);
		...
		$this->add_control(
			'svg_animation',
			[
				'label' => esc_html__( 'Animation', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
                    'none' => esc_html__('None', 'mascot-core-digicod'),
                    'scroll' => esc_html__('Scroll', 'mascot-core-digicod'),
                    'loop' => esc_html__('Loop', 'mascot-core-digicod'),
                ],
				'default' => 'loop',
			]
		);
		...
		$this->add_control(
            'stop_hover',
            [
                'label' => esc_html__('Stop on Hover', 'mascot-core-digicod'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'mascot-core-digicod' ),
				'label_off' => esc_html__( 'Off', 'mascot-core-digicod' ),
				'default' => 'yes',
				'condition' => [
					'svg_animation' => 'loop',
				],
		...
		$this->add_control(
			'divider_text',
			[
				'label' => esc_html__( 'Add Divider', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'mascot-core-digicod' ),
				'label_off' => esc_html__( 'Off', 'mascot-core-digicod' ),
				'default' => 'yes',
		...
		$this->add_control(
			'divider_type',
			[
				'label' => esc_html__( 'Type', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
                    'line' => esc_html__('Line', 'mascot-core-digicod'),
                    'star' => esc_html__('Star', 'mascot-core-digicod'),
					'arrow' => esc_html__('Arrow', 'mascot-core-digicod'),
                    'custom' => esc_html__('Custom', 'mascot-core-digicod'),
                ],
				'condition' => [
					'divider_text' => 'yes',
				],
		...
		$this->add_control(
			'divider_custom',
			[
				'label' => esc_html__( 'Divider Custom', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'clone_text',
			[
				'label' => esc_html__( 'Clone Text', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'mascot-core-digicod' ),
				'label_off' => esc_html__( 'Off', 'mascot-core-digicod' ),
				'default' => 'yes',
		...
		$this->add_control(
            'backspace_count',
            [
                'label' => esc_html__('Space After Cloned Element', 'mascot-core-digicod'),
		...
		$this->add_control(
			'link',
			[
				'label' => esc_html__( 'Link', 'mascot-core-digicod' ),
				'type' => Controls_Manager::URL,
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Paste URL or type', 'mascot-core-digicod' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_responsive_control(
			'align',
			[
				'label' => esc_html__( 'Alignment', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'show_path',
			[
				'label' => esc_html__( 'Show Path', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'mascot-core-digicod' ),
				'label_off' => esc_html__( 'Off', 'mascot-core-digicod' ),
				'separator' => 'before',
	...
	protected function register_style_tab() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Text Styling', 'mascot-core-digicod' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'rotation',
			[
				'label' => esc_html__( 'Rotate', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'range' => [
					'deg' => [
		...
		$this->add_responsive_control(
			'word_spacing',
			[
				'label' => esc_html__( 'Word Spacing', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
            'animation_speed',
            [
                'label' => esc_html__('Animation Duration', 'mascot-core-digicod'),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'default' => 10000,
				'condition' => [
		...
		$this->add_responsive_control(
			'start_point',
			[
				'label' => esc_html__( 'Starting Point', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
                    '%' => ['min' => -1000, 'max' => 1000],
		...
		$this->add_responsive_control(
			'end_point',
			[
				'label' => esc_html__( 'Ending Point', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
                    '%' => ['min' => -1000, 'max' => 1000],
		...
		$this->add_control(
			'text_color_normal',
			[
				'label' => esc_html__( 'Fill Color', 'mascot-core-digicod' ),
				'type' => Controls_Manager::COLOR,
				//'default' => WGL_Globals::get_h_font_color(),
				'selectors' => [
					'{{WRAPPER}} svg text' => 'fill: {{VALUE}};',
					'{{WRAPPER}} .text--word .text' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			'text_theme_colored',
			[
				'label' => esc_html__( "Fill Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg text' => 'fill: var(--theme-color{{VALUE}});',
					'{{WRAPPER}} .text--word .text' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Stroke Width', 'mascot-core-digicod' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'vw' ],
                'range' => [
                    'px' => [ 'min' => 0.1, 'max' => 10 ],
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .text--word .text' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Stroke Color', 'mascot-core-digicod' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg textPath, {{WRAPPER}} svg text' => 'stroke: {{VALUE}};',
					'{{WRAPPER}} .text--word .text' => '-webkit-text-stroke-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Stroke Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg textPath, {{WRAPPER}} svg text' => 'stroke: var(--theme-color{{VALUE}});',
					'{{WRAPPER}} .text--word .text' => '-webkit-text-stroke-color: var(--theme-color{{VALUE}});',
				],
			]
		);
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => esc_html__( 'Hover Animation', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'hover_transition',
			[
				'label' => esc_html__( 'Transition Duration', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0.3,
					'unit' => 's',
		...
		$this->start_controls_tab(
			'text_even_item',
			[
				'label' => esc_html__( 'Even Item', 'mascot-core-digicod' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg text:nth-child(even)' => 'fill: {{VALUE}};',
					'{{WRAPPER}} .text--word:nth-child(even) .text' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg text:nth-child(even)' => 'fill: var(--theme-color{{VALUE}});',
					'{{WRAPPER}} .text--word:nth-child(even) .text' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} svg text:nth-child(even) textPath, {{WRAPPER}} svg text:nth-child(even)' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}}; stroke-width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .text--word:nth-child(even) .text' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg text:nth-child(even) textPath, {{WRAPPER}} svg text:nth-child(even)' => 'stroke: {{VALUE}};',
					'{{WRAPPER}} .text--word:nth-child(even) .text' => '-webkit-text-stroke-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} svg text:nth-child(even) textPath, {{WRAPPER}} svg text:nth-child(even)' => 'stroke: var(--theme-color{{VALUE}});',
					'{{WRAPPER}} .text--word:nth-child(even) .text' => '-webkit-text-stroke-color: var(--theme-color{{VALUE}});',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Divider Styling', 'mascot-core-digicod' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'divider_text!' => '',
				],
        ...
        $this->add_responsive_control(
            'top_offset',
            [
                'label' => esc_html__('Top Offset', 'mascot-core-digicod'),
                'type' => Controls_Manager::NUMBER,
                'min' => -100,
                'max' => 100,
				'step' => 1,
		...
		$this->add_responsive_control(
            'left_offset',
            [
                'label' => esc_html__('Left Offset', 'mascot-core-digicod'),
                'type' => Controls_Manager::NUMBER,
                'min' => -100,
                'max' => 100,
				'step' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Stroke', 'mascot-core-digicod' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->start_controls_section(
			'section_style_path',
			[
				'label' => esc_html__( 'Path', 'mascot-core-digicod' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_path!' => '',
				],
