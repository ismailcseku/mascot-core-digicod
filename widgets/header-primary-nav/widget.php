...
class TM_Elementor_Top_Primary_Nav extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Header Top Primary Nav', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Menu Items Typography/Color', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'menu_item_color',
			[
				'label' => esc_html__( "Menu Item Color", 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Menu Item Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Menu Item Theme Colored", 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Menu Item Theme Colored (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Menu Items Padding/Border Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Items Vertical(Top Bottom) Padding', 'mascot-core-digicod' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Item Left Right Padding', 'mascot-core-digicod' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'menu_item_margin',
			[
				'label' => esc_html__( 'Menu Items Margin', 'mascot-core-digicod' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Menu Last Item Padding/Border Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown Menu Items Typography/Color', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Dropdown Menu Typography', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Text Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Text Theme Colored (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Padding/Border Options', 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		...
		if( mascot_core_theme_active() ) {
			...
			$settings['custom_primary_nav_menu'] = digicod_get_rwmb_group( 'digicod_' . "page_mb_header_settings", 'custom_primary_nav_menu', $current_page_id );
		}
