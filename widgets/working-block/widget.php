<?php
namespace MascotCoreDigicod\Widgets\WorkingBlock;
...
class TM_Elementor_WorkingBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-working-block-loader', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/working-block/working-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Working Block', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'working_block_icons_options', [
				'label' => esc_html__( 'Working Block Items', 'mascot-core-digicod' ),
		...
		$repeater->add_control(
			'icon_type',
			[
				'label' => esc_html__( "Thumb Type", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
	...
	protected function render() {
		...
		//enqueue css
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-working-block-style1', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/working-block/working-block-style1' . $direction_suffix . '.css' );
