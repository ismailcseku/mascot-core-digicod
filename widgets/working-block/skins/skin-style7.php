...
class Skin_Style7 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .working-block-style1' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .working-block-style1' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-working-block-style7', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/working-block/working-block-style7' . $direction_suffix . '.css' );
