...
class Skin_Style12 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		wp_enqueue_style( 'tm-service-block-style12', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/service-block/service-block-style12' . $direction_suffix . '.css' );
	...
	public function get_title() {
		return __( 'Skin Style12', 'mascot-core-digicod' );
	}
