	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .service-block-style4 .inner-box' => 'background-color: {{VALUE}}; border: 1px solid {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-block-style4 .inner-box' => 'background-color: var(--theme-color{{VALUE}}); border: 1px solid var(--theme-color{{VALUE}};'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-block-style4:hover .inner-box' => 'background-color: {{VALUE}}; border: 1px solid var(--theme-color{{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-block-style4:hover .inner-box' => 'background-color: var(--theme-color{{VALUE}}); border: 1px solid var(--theme-color{{VALUE}};'
				],
			]
		);
		$this->end_controls_tab();
