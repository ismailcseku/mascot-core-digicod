...
class Skin_Style11 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		wp_enqueue_style( 'tm-service-block-style11', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/service-block/service-block-style11' . $direction_suffix . '.css' );
	...
	public function get_title() {
		return __( 'Skin Style11', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .service-block-style11 .inner-box' => 'background-color: {{VALUE}}; border: 1px solid {{VALUE}}',
				]
			]
		);
