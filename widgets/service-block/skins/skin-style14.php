...
class Skin_Style14 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		wp_enqueue_style( 'tm-service-block-style14', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/service-block/service-block-style14' . $direction_suffix . '.css' );
	...
	public function get_title() {
		return __( 'Skin Style14', 'mascot-core-digicod' );
	}
