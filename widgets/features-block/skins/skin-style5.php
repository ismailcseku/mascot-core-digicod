...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .features-block-style4:hover' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .features-block-style4:hover' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->end_controls_tab();
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style5', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/features-block/features-block-style5' . $direction_suffix . '.css' );
