...
class Skin_Style4 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style4', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/features-block/features-block-style4' . $direction_suffix . '.css' );
