...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .features-block-style3 .inner-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .features-block-style3 .inner-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .features-block-style3 .inner-box:before' => 'opacity: {{SIZE}};',
				],
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style3', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/features-block/features-block-style3' . $direction_suffix . '.css' );
