...
class TM_Elementor_Blog_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog/News Widget', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'img_options', [
				'label' => esc_html__( 'Image Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'thumb_margin_right',
			[
				'label' => esc_html__( "Thumb Margin Right", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->start_controls_section(
			'content',
			[
				'label' => esc_html__( 'Content Placement', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'title_length', [
				'label' => esc_html__( "Title Length", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_control(
			'post_meta_placement', [
				...
				'options' => [
					...
					'center' => esc_html__( 'Middle', 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Post Excerpt Styling', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'blog-list', null, 'blog-list/tpl', $settings, true );
