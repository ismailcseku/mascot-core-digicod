...
class TM_Elementor_TestimonialBlock extends Widget_Base {
	...
	protected function render() {
		...
		//enqueue css
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-testimonial-block-style1', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style1' . $direction_suffix . '.css' );
