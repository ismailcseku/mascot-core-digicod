...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-testimonial-block-style3', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style3' . $direction_suffix . '.css' );
