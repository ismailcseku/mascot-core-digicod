...
class Skin_Style7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style7', 'mascot-core-digicod' );
	}
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .testimonial-block .info-box .thumb' => 'border: 2px solid {{VALUE}};'
				]
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-testimonial-block-style7', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style7' . $direction_suffix . '.css' );
