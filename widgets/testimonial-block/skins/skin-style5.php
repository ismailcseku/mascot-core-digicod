...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style5', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Star Rating Color Options', 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			'current_rating_color_options_color',
			[
				'label' => esc_html__( "Star Rating Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .rating .star-rating span:before' => 'color: {{VALUE}};',
					'{{WRAPPER}} .testimonial-block .rating .rating-count' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Star Rating BG Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .rating' => 'background: {{VALUE}}; border: 1px solid {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'text-shadow: 1px 1px 1px {{VALUE}}, -1px -1px 1px {{VALUE}}, 1px 1px 1px {{VALUE}}, -1px -1px 1px {{VALUE}}, 1px 1px 1px {{VALUE}}, -1px -1px 1px {{VALUE}};',
					'{{WRAPPER}} .testimonial-block .testimonial-content:hover .quote-icon' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'text-shadow: var(--theme-color{{VALUE}});'
				],
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-testimonial-block-style5', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style5' . $direction_suffix . '.css' );
