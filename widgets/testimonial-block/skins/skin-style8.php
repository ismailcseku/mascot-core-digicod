...
class Skin_Style8 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style8', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Star Rating border Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .info-box' => 'border-bottom: 2px solid {{VALUE}};',
					'{{WRAPPER}} .testimonial-block .rating' => 'border: 1px solid {{VALUE}};'
				]
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-testimonial-block-style8', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style8' . $direction_suffix . '.css' );
