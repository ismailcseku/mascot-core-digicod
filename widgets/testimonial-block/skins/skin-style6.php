...
class Skin_Style6 extends Elementor_Skin_Base {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon-two' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-testimonial-block-style6', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style6' . $direction_suffix . '.css' );
