...
class Skin_Style4 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		//Content Inside Border Normal Color
		$this->add_responsive_control(
			'content_area_inside_normal_border_color',
			[
				'label' => esc_html__( "Inside Border Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		//Content Inside Border Hover Color
		$this->add_responsive_control(
			'content_area_inside_hover_border_color',
			[
				'label' => esc_html__( "Inside Border Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
		...
		//Normal Color
		$this->start_controls_tab(
			'content_quote_icon_normal_styling',
			[
				'label' => esc_html__('Normal', 'mascot-core-digicod'),
			]
		);
		$this->add_responsive_control(
			'content_quote_icon_normal_bg_color',
			[
				'label' => esc_html__( "Quote Icon BG Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			'content_quote_icon_normal_bg_theme_colored',
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_responsive_control(
			'content_quote_icon_normal_border_color',
			[
				'label' => esc_html__( "Quote Icon Border Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'border-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			'content_quote_icon_normal_color',
			[
				'label' => esc_html__( "Quote Icon Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			'content_quote_icon_normal_theme_colored',
			[
				'label' => esc_html__( "Quote Icon Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testimonial-block .testimonial-content .quote-icon' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			'content_quote_icon_hover_bg_color',
			[
				'label' => esc_html__( "Quote Icon BG Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block:hover .testimonial-content .quote-icon' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			'content_quote_icon_hover_border_color',
			[
				'label' => esc_html__( "Quote Icon Border Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block:hover .testimonial-content .quote-icon' => 'border-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testimonial-block:hover .testimonial-content .quote-icon' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .testimonial-block:hover .testimonial-content .quote-icon' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testimonial-block:hover .testimonial-content .quote-icon' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-testimonial-block-style4', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/testimonial-block/testimonial-block-style4' . $direction_suffix . '.css' );
