<?php
namespace MascotCoreDigicod\Widgets\PricingPlan\Skins;
...
class Skin_Pricing_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style2', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Head Section Options', 'mascot-core-digicod' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Head Background', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Head BG Theme Colored", 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Head BG Theme Colored (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'wrapper_padding',
			[
				'label' => esc_html__( 'Head Padding', 'mascot-core-digicod' ),
	...
	public function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'pricing-plan', $settings['_skin'], 'pricing-plan/tpl', $settings, true );
