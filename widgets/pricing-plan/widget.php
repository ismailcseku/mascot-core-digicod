<?php
namespace MascotCoreDigicod\Widgets\PricingPlan;
...
class TM_Elementor_Pricing_Plan extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_enqueue_style( 'tm-pricing-plan-style', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/pricing-plan/pricing-plan-loader' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing Plan - Digicod', 'mascot-core-digicod' );
	}
	...
	protected function register_skins() {
		...
		$this->add_skin( new Skins\Skin_Pricing_Style5( $this ) );
		$this->add_skin( new Skins\Skin_Pricing_Style6( $this ) );
		$this->add_skin( new Skins\Skin_Pricing_Style7( $this ) );
		$this->add_skin( new Skins\Skin_Pricing_Style8( $this ) );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Sample Title", 'mascot-core-digicod' )
			]
		);
		$this->add_control(
			'title_tag',
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Starts at $14. Includes 2 users", 'mascot-core-digicod' )
			]
		);
		$this->add_control(
			'subtitle_tag',
		...
		$this->add_control(
			'label_text',
			[
				'label' => esc_html__( "Label/Offer/Tag Text", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Most Popular", 'mascot-core-digicod' )
			]
		);
		$this->add_control(
			'footer_hint_text',
			[
				'label' => esc_html__( "Footer Hint Text", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "* No credit card required", 'mascot-core-digicod' )
			]
		);
		...
		$this->start_controls_section(
			'price_plan_default',
			[
				'label' => esc_html__( 'Price Plan - Default', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'price',
			[
				'label' => esc_html__( "Price", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "199", 'mascot-core-digicod' )
			]
		);
		$this->add_control(
			'on_sale', [
				'label' => esc_html__( "On sale?", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'price_sale',
			[
				'label' => esc_html__( "Sale Price", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "149", 'mascot-core-digicod' ),
				'condition' => [
					'on_sale' => array('yes')
				],
			]
		...
		$this->add_control(
			'price_prefix',
			[
				'label' => esc_html__( "Prefix (Currency)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "$", 'mascot-core-digicod' )
			]
		);
		$this->add_control(
			'price_separator',
			[
				'label' => esc_html__( "Separator", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "/", 'mascot-core-digicod' )
			]
		);
		$this->add_control(
			'price_postfix',
			[
				'label' => esc_html__( "Postfix (Period)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Monthly", 'mascot-core-digicod' )
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Price Plan - Secondary', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sale Price", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "349", 'mascot-core-digicod' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Postfix (Period)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Yearly", 'mascot-core-digicod' )
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Features/Options List', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'features_list_title',
			[
				'label' => esc_html__( "Features Title", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "All basic services include:", 'mascot-core-digicod' )
			]
		);
		$repeater = new \Elementor\Repeater();
		$repeater->add_control(
			'disable_item', [
				'label' => esc_html__( "Disable This Item (Blur)?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$repeater->add_control(
			'line_through', [
				'label' => esc_html__( "Add Line Through Text?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$repeater->add_control(
			'tooltip_text',
			[
				'label' => esc_html__( "Tooltip Text", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Start your free trial", 'mascot-core-digicod' )
			]
		);
		$repeater->add_control(
			'content',
		...
		$this->add_control(
			'features_list',
			[
				'label' => esc_html__( "Features Items", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'content' => esc_html__( "Full Access to the Library", 'mascot-core-digicod' ),
					],
					[
						'content' => esc_html__( "Complete Documentation", 'mascot-core-digicod' ),
					],
					[
						'disable_item' => 'yes',
						'content' => esc_html__( "24/7 Free Support", 'mascot-core-digicod' ),
					],
					[
						'line_through' => 'yes',
						'content' => esc_html__( "Cloud Storage Backup", 'mascot-core-digicod' ),
					],
				],
			]
		);
		...
		$this->start_controls_section(
			'thumb_options',
			[
				'label' => esc_html__( 'Thumb Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'pricing_image',
			[
				'label' => esc_html__( "Pricing Thumbnail Image", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'pricing_image_hover',
			[
				'label' => esc_html__( "Thumbnail Image (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( "This image will be shown on the top of the pricing table", 'mascot-core-digicod' ),
			]
		);
		...
		$this->add_responsive_control(
			'pricing_image_width',
			[
				'label' => esc_html__( "Image Custom Width", 'mascot-core-digicod' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Margin', 'mascot-core-digicod' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Padding', 'mascot-core-digicod' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Icons Options', 'mascot-core-digicod' ),
		...
		$this->add_responsive_control(
			'hide_icon',
			[
				'label' => esc_html__( 'Show/Hide Features Icon', 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Styling', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'list_bordered',
			[
				'label' => esc_html__( "Make List(ul, li) Border Bottom?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Custom Border', 'mascot-core-digicod' ),
				'selector' => '{{WRAPPER}} .features-list li',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Bottom Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Bottom Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Disabled Icons Styling', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Disabled Text Styling', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Line Through Icons Styling', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Line Through Text Styling', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Tooltip Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Show/Hide Features Tooltip', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Hide', 'mascot-core-digicod' ),
				'label_off' => __( 'Show', 'mascot-core-digicod' ),
				'return_value'	=> 'none',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Tooltip Icon Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Tooltip Icon Typography', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Tooltip Text Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Tooltip Text Typography', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Tooltip Text Background Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Tooltip Text BG Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'title_options',
			[
				'label' => esc_html__( 'Title Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'title_text_color',
			[
				'label' => esc_html__( "Title Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'sub_title_options',
			[
				'label' => esc_html__( 'Sub Title Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Custom CSS Class", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		//Content
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Sub Title Border', 'mascot-core-digicod' ),
				'selector' => '{{WRAPPER}} .pricing-plan-title-area .pricing-plan-subtitle',
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			'price_options',
			[
				'label' => esc_html__( 'Price Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab(
			'price_value_style',
			[
				'label' => esc_html__('Price Value', 'mascot-core-digicod'),
			]
		);
		$this->add_control(
			'price_text_color',
		...
		$this->add_group_control(
			...
			[
				'name' => 'pricing_border',
				'label' => esc_html__( 'Price Border', 'mascot-core-digicod' ),
		...
		$this->start_controls_tab(
			'price_prefix_style',
			[
				'label' => esc_html__('Prefix', 'mascot-core-digicod'),
			]
		);
		$this->add_control(
			'price_prefix_options',
			[
				'label' => esc_html__( 'Price Prefix Options', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Price Separator Options', 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			'price_postfix_style',
			[
				'label' => esc_html__('Postfix', 'mascot-core-digicod'),
			]
		);
		$this->add_control(
			'price_postfix_options',
			[
				'label' => esc_html__( 'Price Postfix Options', 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			'label_offer_options',
			[
				'label' => esc_html__( 'Label/Offer/Tag Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Label Text Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Label Text Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Label Typography', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Label Custom Background Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Label Custom Background Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Label Background Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Label Background Theme Colored (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'link_secondary',
			[
				'label' => esc_html__( "Link URL - Secondary", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::URL,
				'show_external' => true,
				'default' => [
				'url' => '',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Footer Hint Text Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		//Content
		...
		$this->start_controls_section(
			'bg_wrapper_options',
			[
				'label' => esc_html__( 'Wrapper Background Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Default', 'mascot-core-digicod'),
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Wrapper BG Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Wrapper Border', 'mascot-core-digicod' ),
				'separator' => 'before',
				'selector' => '{{WRAPPER}} .tm-sc-pricing-plan .pricing-plan-inner-wrapper',
			]
		);
		...
		$this->add_responsive_control(
			'wrapper_margin',
			[
				'label' => esc_html__( 'Parent Wrapper Margin', 'mascot-core-digicod' ),
				'type' => Controls_Manager::DIMENSIONS,
				'separator' => 'before',
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'wrapper_padding',
			[
				'label' => esc_html__( 'Parent Wrapper Padding', 'mascot-core-digicod' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'content_padding',
			[
				'label' => esc_html__( 'Inner Content Padding', 'mascot-core-digicod' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Add Default Box Shadow Around Plan?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Make This Plan Featured?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Featured Pricing Plan has some different looks to highlight it", 'mascot-core-digicod' ),
				'default' => 'no',
			]
		);
		$this->add_control(
			'make_hover_effect',
			[
				'label' => esc_html__( "Make Hover Effect on This Plan?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'description' => esc_html__( "There will be a transition when hovering on this table", 'mascot-core-digicod' ),
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper Background - Before', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Opacity', 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper Background - After', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'pricing-plan-skin-default', null, 'pricing-plan/tpl', $settings, true );
