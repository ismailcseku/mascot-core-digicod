<?php
namespace MascotCoreDigicod\Widgets\InteractiveTabs;
...
class TM_Elementor_InteractiveTabsTitle extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Interactive Tabs - Title', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Slave Tab Content ID', 'mascot-core-digicod'),
		...
		$repeater->add_control(
			'activate',
			[
				'label' => esc_html__( "Make It Active?", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'list_items',
			[
				'label'		  => esc_html__( 'Tab Title List', 'mascot-core-digicod' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'title' => esc_html__('Creative', 'mascot-core-digicod'),
						'activate' => 'yes',
					],
					[
						'title' => esc_html__('Agency', 'mascot-core-digicod'),
					]
				],
				'title_field' => '{{{ title }}}',
			]
		...
		$this->add_control(
			'icon',
			[
				'label' => __('Arrow Icon', 'mascot-core-digicod'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Hover/Active', 'mascot-core-digicod'),
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'icon_text_color',
			[
				'label' => esc_html__( "Icon Text Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Text Color (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'interactive-tabs-title-default', null, 'interactive-tabs-title/tpl', $settings, true );
