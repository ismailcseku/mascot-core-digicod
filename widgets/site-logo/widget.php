...
class TM_Elementor_Site_Logo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Site Logo', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'site_logo_alignment',
			[
				'label' => esc_html__( "Logo Alignment", 'mascot-core-digicod' ),
		...
		$this->add_responsive_control(
			'logo_margin',
			[
				'label' => esc_html__( 'Logo Margin', 'mascot-core-digicod' ),
