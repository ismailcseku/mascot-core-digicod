...
class TM_Elementor_App_Button extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-app-button', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/app-button' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Tm - App Button', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Download on the", 'mascot-core-digicod' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "App Store", 'mascot-core-digicod' ),
			]
		);
		$this->add_control(
			'link',
		...
		$this->add_control(
			'icon_border_color',
			[
				'label' => esc_html__( "Right Border Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'app-button', null, 'app-button/tpl', $settings, true );
