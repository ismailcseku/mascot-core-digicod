...
class TM_Elementor_Spin_Text_Around_Logo extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-spin-text-around-logo', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/spin-text-around-logo' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Spin Text Around Logo', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'spin_image',
			[
				'label' => esc_html__( "Spin Image", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'text',
			[
				'label' => esc_html__( "Text in Center", 'mascot-core-digicod' ),
