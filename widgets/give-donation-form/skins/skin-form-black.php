...
class Skin_Form_Black extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-form-black';
	}


	public function get_title() {
		return __( 'Skin Form Black on White BG', 'mascot-core-digicod' );
	}
	...
	public function render() {
		...
		$settings['heading_title'] = $this->parent->get_heading_title($settings);
