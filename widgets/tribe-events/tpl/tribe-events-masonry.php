...
<?php if ( $the_query->have_posts() ) : ?>
	<div class="tm-sc-tribe-events tm-sc-tribe-events-masonry <?php if( !empty($classes) ) echo esc_attr(implode(' ', $classes)); ?>">
		...
		<div id="<?php echo esc_attr( $holder_id ) ?>" class="isotope-layout masonry grid-<?php echo esc_attr( $columns ); ?> <?php echo esc_attr( $gutter );?> clearfix">
			<div class="isotope-layout-inner">
                ...
                <div class="isotope-item <?php echo esc_attr( $term_slugs_list_string );?>">
                    <?php mascot_core_digicod_get_shortcode_template_part( 'each-item', $_skin, 'tribe-events/tpl', $params, false );?>
                </div>
                <?php endwhile; ?>
                <!-- end of the loop -->
			</div>
