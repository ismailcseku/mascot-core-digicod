...
<?php if ( $the_query->have_posts() ) : ?>
  <div class="tm-sc-tribe-events tm-sc-tribe-events-vertical-list-current-theme <?php if( !empty($classes) ) echo esc_attr(implode(' ', $classes)); ?>">
    <!-- the loop -->
    <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
      <div class="event <?php tribe_events_event_classes() ?>">
        <div class="event-left <?php echo esc_attr(implode(' ', $event_left_classes)); ?>">
          <?php if ( has_post_thumbnail() && $skin_vertical_list_current_theme_show_left_thumb == 'yes' ) : ?>
          <div class="event-thumb">
            <?php echo tribe_event_featured_image( null, $skin_vertical_list_current_theme_left_thumb_image_size ); ?>
            <?php if ( $skin_vertical_list_current_theme_show_left_date == 'yes' &&  $skin_vertical_list_current_theme_left_date_placement == 'left'  ) : ?>
        ...
        <?php if ( $skin_vertical_list_current_theme_show_left_date == 'yes' &&  $skin_vertical_list_current_theme_left_date_placement == 'right'  ) : ?>
