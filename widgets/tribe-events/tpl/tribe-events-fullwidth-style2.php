<?php if ( $the_query->have_posts() ) : ?>
  <div class="tm-sc-tribe-events events-fullwidth-style2 <?php if( !empty($classes) ) echo esc_attr(implode(' ', $classes)); ?>">
    <!-- the loop -->
        ...
        <div class="col-md-12">
          <div class="event <?php tribe_events_event_classes() ?>">
            <div class="event-wrapper">
              <?php if ( $skin_fullwidth_style2_show_left_date == 'yes' &&  $skin_fullwidth_style2_left_date_placement == 'left' ) : ?>
              <div class="event-date">
                ...
                <span class="month"><?php echo tribe_get_start_date( get_the_ID(), false, $skin_fullwidth_style2_date_single_meta_date_format_month ) ?></span>
                <span class="year"><?php echo tribe_get_start_date( get_the_ID(), false, $skin_fullwidth_style2_date_single_meta_date_format_year ) ?></span>
              </div>
              <?php endif; ?>

              <?php if ( has_post_thumbnail() && $skin_fullwidth_style2_show_left_thumb == 'yes' ) : ?>
              <div class="event-thumb">
                <?php echo tribe_event_featured_image( null, $skin_fullwidth_style2_left_thumb_image_size ); ?>
              </div>
              <?php endif; ?>
