...
class Skin_Fullwidth_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-fullwidth-style-current-theme1';
	}


	public function get_title() {
		return __( 'Skin Fullwidth Current Theme1', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		//List - Fullwidth Options
		$this->start_controls_section(
			'thumb_options', [
				'label' => esc_html__( 'List Fullwidth - Thumb Options', 'mascot-core-digicod' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb' => 'width: {{SIZE}}{{UNIT}};max-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb' => 'flex-basis: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb img' => 'width: {{SIZE}}{{UNIT}};max-width: {{SIZE}}{{UNIT}};'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tm-sc-tribe-events .event .event-thumb',
			]
		);
		$this->add_group_control(
		...
		$this->start_controls_section(
			'date_options', [
				'label' => esc_html__( 'List Fullwidth - Date Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date' => 'width: {{SIZE}}{{UNIT}};max-width: {{SIZE}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .day' => 'display: none;',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .day' => 'display: block;',
				]
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tm-sc-tribe-events .event .event-date .day',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .day' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date .day' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .day' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date .day' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .day' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .month' => 'display: none;',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .month' => 'display: block;',
				]
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tm-sc-tribe-events .event .event-date .month',
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .month' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date .month' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .month' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date .month' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .month' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .year' => 'display: none;',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .year' => 'display: block;',
				]
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tm-sc-tribe-events .event .event-date .year',
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .year' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date .year' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .year' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date .year' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date .year' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event:hover .event-date' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-tribe-events .event .event-date' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tm-sc-tribe-events .event .event-date',
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->start_controls_section(
			'wrapper_options', [
				'label' => esc_html__( 'List - Fullwidth Wrapper Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'flex_options',
			[
				'label' => esc_html__( 'Fullwidth Placement Option', 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_control(
			'flex_vertical',
			[
				'label' => esc_html__( "Fullwidth Alignment", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		//List - Fullwidth Slide Options
		$this->start_controls_section(
			'slide_options', [
				'label' => esc_html__( 'List - Fullwidth Slide Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'slide_navigation_arrow_position', [
				...
				'default' => 'top',
				'condition' => [
					'slide_show_navigation' => array('yes')
				]
			]
		);
		$this->end_controls_section();
	...
	public function render_output( $class_instance, $settings ) {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'tribe-events-fullwidth-style-current-theme1', null, 'tribe-events/tpl', $settings, true );
