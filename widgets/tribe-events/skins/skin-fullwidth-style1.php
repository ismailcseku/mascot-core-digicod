...
class Skin_Fullwidth_Style1 extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-fullwidth-style1';
	}


	public function get_title() {
		return __( 'Skin Fullwidth Style1', 'mascot-core-digicod' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'tribe-events-fullwidth-style1', null, 'tribe-events/tpl', $settings, true );
