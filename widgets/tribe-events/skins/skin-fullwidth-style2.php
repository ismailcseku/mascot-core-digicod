...
class Skin_Fullwidth_Style2 extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-fullwidth-style2';
	}


	public function get_title() {
		return __( 'Skin Fullwidth Style2', 'mascot-core-digicod' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'tribe-events-fullwidth-style2', null, 'tribe-events/tpl', $settings, true );
