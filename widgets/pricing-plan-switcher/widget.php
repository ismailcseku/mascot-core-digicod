<?php
namespace MascotCoreDigicod\Widgets\PricingPlanSwitcher;
...
class TM_Elementor_Pricing_Plan_Switcher extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pricing Plan Switcher - Digicod', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'general',
			[
				'label' => esc_html__( 'Switcher Variants', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Default Variant Name", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Monthly", 'mascot-core-digicod' ),
				"description" => esc_html__( "Enter the default switcher variant name", 'mascot-core-digicod' ),
			]
		);
		$this->add_control(
			'variant_text_secondary',
			[
				'label' => esc_html__( "Secondary Variant Name", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Yearly", 'mascot-core-digicod' ),
				"description" => esc_html__( "Enter the secondary switcher variant name", 'mascot-core-digicod' ),
			]
		);
		$this->add_control(
			'variant_text_offer',
			[
				'label' => esc_html__( "Offer Text", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "20% Off", 'mascot-core-digicod' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Default Variant Options', 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Secondary Variant Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Offer Text Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text Background Color", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text BG Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Bullet Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
	...
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'switcher-skin-style1', null, 'pricing-plan-switcher/tpl', $settings, true );
