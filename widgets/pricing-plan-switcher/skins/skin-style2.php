<?php
namespace MascotCoreDigicod\Widgets\PricingPlanSwitcher\Skins;
...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'default_options',
			[
				'label' => esc_html__( 'Default Settings', 'mascot-core-digicod' ),
        ...
        $this->add_control(
            'round_button',
            [
                'label' => esc_html__( 'Round Button', 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Active/Hover Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	public function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'switcher', $settings['_skin'], 'pricing-plan-switcher/tpl', $settings, true );
