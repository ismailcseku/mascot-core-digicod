...
class TM_Elementor_Countdown_Timer extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'tm-countdown-timer-current-style-script', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/js/widgets/countdown-timer.js' );

		wp_register_style( 'tm-countdown-timer-current-style', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/shortcodes/countdown-timer' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Countdown Timer (Digicod)', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Future Ending Date & Time (Format Y/m/d H:i:s)", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'show_time',
			[
				'label' => esc_html__( "Show Time?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'mascot-core-digicod' ),
				'label_off' => esc_html__( 'No', 'mascot-core-digicod' ),
				'return_value' => 'yes',
				'default' => 'yes',
				'description' => esc_html__( "Show or Hide Time of the date", 'mascot-core-digicod' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Block Horizontal Alignment(Flex)", 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			'Word_options',
			[
				'label' => esc_html__( 'Word Options', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'word_month',
			[
				'label' => esc_html__( "Word - Month", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'word_week',
			[
				'label' => esc_html__( "Word - Week", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'weeks'
			]
		);
		$this->add_control(
			'word_day',
			[
				'label' => esc_html__( "Word - Day", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'days'
			]
		);
		$this->add_control(
			'word_hr',
			[
				'label' => esc_html__( "Word - Hour", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'hr'
			]
		);
		$this->add_control(
			'word_min',
			[
				'label' => esc_html__( "Word - Minute", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'min'
			]
		);
		$this->add_control(
			'word_sec',
			[
				'label' => esc_html__( "Word - Second", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'sec'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Label Styling', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Block', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_template_part( 'tpl-smart-style', null, 'countdown-timer/tpl', $settings, true );
