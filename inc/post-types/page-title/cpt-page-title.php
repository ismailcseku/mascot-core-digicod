<?php
namespace MASCOTCOREDIGICOD\CPT\PageTitle;
 ...
 * Singleton class
 * class CPT_PageTitle
 * @package MASCOTCOREDIGICOD\CPT\PageTitle;
 */
final class CPT_PageTitle implements Lib\Mascot_Core_Digicod_Interface_PostType {
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Page Title', 'mascot-core-digicod' );
		$this->ptPluralName = esc_html__( 'Parts - Page Title', 'mascot-core-digicod' );
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-page-title'	=> esc_html__( 'Currently Active Page Title', 'mascot-core-digicod' ),
		...
		switch( $columns ) {
			case 'active-page-title' :
				if( mascot_core_digicod_theme_installed() ) {
					$active_headertop_id = digicod_get_redux_option( 'page-title-settings-choose-page-title-cpt-widget-area', 'default' );
