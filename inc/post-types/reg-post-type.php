<?php
namespace MASCOTCOREDIGICOD\CPT;

use MASCOTCOREDIGICOD\Lib;

/**
 * class Reg_Post_Type
 * @package MASCOTCOREDIGICOD\CPT;
 */
class Reg_Post_Type {
	/**
	 ...
	 */
	private function add_new_post_type(Lib\Mascot_Core_Digicod_Interface_PostType $newPostType) {
...
add_action('elementor/init','MASCOTCOREDIGICOD\CPT\tm_enable_elementor_for_all_cpt');