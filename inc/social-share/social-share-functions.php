...
if(!function_exists('mascot_core_digicod_get_social_share_links')) {
	/**
	 * Function that Renders Social Share Links
	 * @return HTML
	 */
	function mascot_core_digicod_get_social_share_links() {
		$params = array();

		if( !digicod_get_redux_option( 'sharing-settings-enable-sharing' ) ) {
			return;
		}
		...
		$params['enabled_social_networks'] = digicod_get_redux_option( 'sharing-settings-networks', false, 'Enabled' );
		$params['sharing_heading'] = digicod_get_redux_option( 'sharing-settings-heading' );
		$params['tooltip_directions'] = digicod_get_redux_option( 'sharing-settings-tooltip-directions' );

		//icon type
		$params['social_icon_type'] = digicod_get_redux_option( 'sharing-settings-icon-type' );

		//icon property
		$params['social_links_icon_color'] = digicod_get_redux_option( 'sharing-settings-social-links-color' );
		$params['social_links_icon_style'] = digicod_get_redux_option( 'sharing-settings-social-links-icon-style' );
		$params['social_links_icon_size'] = digicod_get_redux_option( 'sharing-settings-social-links-icon-size' );
		$params['social_links_animation_effect'] = digicod_get_redux_option( 'sharing-settings-social-links-icon-animation-effect' );
		$params['social_links_icon_border_style'] = digicod_get_redux_option( 'sharing-settings-social-links-icon-border-style' );
		$params['social_links_icon_theme_colored'] = digicod_get_redux_option( 'sharing-settings-social-links-theme-colored' );
		...
		$params['social_network_list'] = array(
			...
			'print' => array(
				...
				"text" => digicod_get_redux_option( 'sharing-settings-tooltip-print' )
			),
		);
