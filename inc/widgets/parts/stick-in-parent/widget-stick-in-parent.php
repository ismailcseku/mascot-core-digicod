...
/*
 * Adds Mascot_Core_Digicod_Widget_StickInParent widget.
 */
if( !class_exists( 'Mascot_Core_Digicod_Widget_StickInParent' ) ) {
class Mascot_Core_Digicod_Widget_StickInParent extends Mascot_Core_Digicod_Widget_Loader {
	...
	function __construct() {
		...
		parent::__construct( 'tm_widget_stick_in_parent', esc_html__( '(TM) Stick Sidebar In Parent', 'mascot-core-digicod' ), $this->widgetOptions );
		$this->getFormFields();
	}
	...
	public function widget( $args, $instance ) {
		...
		$html = mascot_core_digicod_get_widget_template_part( 'stick-in-parent', null, 'stick-in-parent/tpl', $instance, false );
