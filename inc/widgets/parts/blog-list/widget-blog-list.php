...
/*
 * Adds Mascot_Core_Digicod_Widget_BlogList widget.
 */
if( !class_exists( 'Mascot_Core_Digicod_Widget_BlogList' ) ) {
class Mascot_Core_Digicod_Widget_BlogList extends Mascot_Core_Digicod_Widget_Loader {
	...
	function __construct() {
		...
		parent::__construct( 'tm_widget_blog_list', esc_html__( '(TM) Latest News', 'mascot-core-digicod' ), $this->widgetOptions );
		$this->getFormFields();
	}
	...
	protected function getFormFields() {
		$this->formFields = array(
			array(
				...
				'desc'		=> '',
				'default'	=> esc_html__( 'Latest News', 'mascot-core-digicod' ),
			),
			array(
				'id'		=> 'custom_css_class',
				'type'		=> 'text',
			...
			array(
				'id'		=> 'num_of_posts',
				'type'		=> 'text',
				'title'		=> esc_html__( 'Number of Posts:', 'mascot-core-digicod' ),
				'desc'		=> '',
			),
			array(
				'id'		=> 'limit_title_words',
				'type'		=> 'text',
				'title'		=> esc_html__( 'Limit number of words to display in title:', 'mascot-core-digicod' ),
				'desc'		=> '',
			),
			array(
				'id'		=> 'blog_category',				
				...
				'desc'		=> '',
				'options'	=> mascot_core_digicod_get_post_all_categories_array()
			),
			array(
				'id'		=> 'order_by',
				'type'		=> 'dropdown',
				'title'		=> esc_html__( 'Order By:', 'mascot-core-digicod' ),
				'desc'		=> '',
				'options'	=> array(
					'title'		=> esc_html__( 'Title', 'mascot-core-digicod' ),
					'date'			=> esc_html__( 'Date', 'mascot-core-digicod' ),
					'comment_count' => esc_html__( 'Number of Comments', 'mascot-core-digicod' )
				)
			),
			array(
				'id'		=> 'order',
				'type'		=> 'dropdown',
				'title'		=> esc_html__( 'Order:', 'mascot-core-digicod' ),
				'desc'		=> '',
				'options'	=> array(
			...
			array(
				'id'		=> 'disable_thumb',
				'type'		=> 'checkbox',
				'title'		=> esc_html__( 'Disable Thumbnail', 'mascot-core-digicod' ),
				'desc'		=> '',
				'value'	=> 'on',
			),
			array(
				'id'		=> 'post_title_tag',
				'type'		=> 'dropdown',
				'title'		=> esc_html__( 'Post Title Tag:', 'mascot-core-digicod' ),
				'desc'		=> '',
				'options'	=> array(
					'h6' => 'h6',
					'h5' => 'h5',
