...
/**
 * abstract class Mascot_Core_Digicod_Widget_Loader
 */
if( !class_exists( 'Mascot_Core_Digicod_Widget_Loader' ) ) {
abstract class Mascot_Core_Digicod_Widget_Loader extends WP_Widget {
	...
	public function form( $instance ) {
		...
		foreach( $this->formFields as $eachFormField ) {
			...
			?>
				<p>
				<?php esc_html_e( 'Error! Undefined field Type.', 'mascot-core-digicod' ); ?>
				</p>
			<?php
			break;
			}
			...
			<p><?php esc_html_e( 'No options found for this widget!', 'mascot-core-digicod' ); ?></p>
		<?php }
	}
}
}