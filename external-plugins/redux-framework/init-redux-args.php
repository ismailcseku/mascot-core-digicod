<?php
    ...
    $args = array(
        ...
        'display_name'         => esc_html__( 'Theme Options', 'mascot-core-digicod' ),
        ...
        'menu_title'           => esc_html__( 'Theme Options', 'mascot-core-digicod' ),
        'page_title'           => esc_html__( 'Theme Options', 'mascot-core-digicod' ),
        ...
        'global_variable'      => 'digicod_redux_theme_opt',
        ...
        'hints'                => array(
            ...
            'icon_position' => esc_html__( 'Right', 'mascot-core-digicod' ),
    ...
    /*$args['admin_bar_links'][] = array(
        ...
        'title' => esc_html__( 'Documentation', 'mascot-core-digicod' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-support',
        'href'  => 'https://github.com/ReduxFramework/redux-framework/issues',
        'title' => esc_html__( 'Support', 'mascot-core-digicod' ),
    );*/
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        //$args['intro_text'] = sprintf( esc_html__( '<p>Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: <strong>$%1$s</strong></p>', 'mascot-core-digicod' ), $v );
    } else {
        //$args['intro_text'] = esc_html__( '<p>This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.</p>', 'mascot-core-digicod' );
    }
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => esc_html__( 'Theme Information 1', 'mascot-core-digicod' ),
            'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'mascot-core-digicod' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => esc_html__( 'Theme Information 2', 'mascot-core-digicod' ),
            'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'mascot-core-digicod' )
        )
    );
    ...
    $content = esc_html__( '<p>This is the sidebar content, HTML is allowed.</p>', 'mascot-core-digicod' );
    ...
    */
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            //$sections = array();
            $sections[] = array(
                'title'  => esc_html__( 'Section via hook', 'mascot-core-digicod' ),
                'desc'   => esc_html__( '<p class="description">This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.</p>', 'mascot-core-digicod' ),
    ...
    function mascot_core_digicod_redux_opt_maintenance_section() {
        $site_url = site_url();
        ...
        $maintenance_section =  array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'type'     => 'sorter',
                    'title'    => esc_html__( 'Layout Ordering', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Reorder them by shifting up and down.', 'mascot-core-digicod' ),
                    'desc'     => '',
                    'compiler' => 'true',
                    'options'  => array(
                        'ordering' => array(
                ...
                array(
                    ...
                    'type'     => 'switch',
                    'title'    => esc_html__( 'Enable Social Links', 'mascot-core-digicod' ),
                    'subtitle' => '',
                    'default'  => 0,
                ...
                array(
                    ...
                    'type'     => 'switch',
                    'title'    => esc_html__( 'Show Logo', 'mascot-core-digicod' ),
                    'subtitle' => '',
                    'default'  => 0,
                    'on'       => esc_html__( 'Yes', 'mascot-core-digicod' ),
                    'off'      => esc_html__( 'No', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'    => 'spinner',
                    'title'   => esc_html__( 'Logo Maximum Width', 'mascot-core-digicod' ),
                    'desc'    => esc_html__( 'Set maximum width for uploaded logo (in px)', 'mascot-core-digicod' ),
                    'default' => '200',
                    'min'     => '20',
                    'step'    => '1',
                    'max'     => '1000',
                ...
                array(
                    ...
                    'subtitle' => esc_html__( 'Define text and styles for Title.', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'     => 'text',
                    'title'    => esc_html__( 'Title Text', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Set page title to show', 'mascot-core-digicod' ),
                    'desc'     => '',
                    'default'  => esc_html__( 'Site Under Construction', 'mascot-core-digicod' ),
                    'required' => array( 'maintenance-mode-settings-status', '=', '1' ),
                ),
                array(
                    'id'            => 'maintenance-mode-settings-title-typography',
                    'type'          => 'typography',
                    'title'         => esc_html__( 'Title Typography', 'mascot-core-digicod' ),
                    'subtitle'      => '',
                ...
                array(
                    ...
                    'type'     => 'section',
                    'title'    => esc_html__( 'Content', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Define text and styles for Content.', 'mascot-core-digicod' ),
                    'indent'   => true, // Indent all options below until the next 'section' option is set.
                    'required' => array( 'maintenance-mode-settings-status', '=', '1' ),
                ),
                array(
                    ...
                    'type'     => 'editor',
                    'title'    => esc_html__( 'Content Text', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Enter the content for maintenance page which will be showed below logo and countdown timer if those are selected', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'          => 'typography',
                    'title'         => esc_html__( 'Content Typography', 'mascot-core-digicod' ),
                    'subtitle'      => '',
                    //'compiler'    => true,  // Use if you want to hook in your own CSS compiler
                    'google'        => true,
                    // Disable google fonts. Won't work if you haven't defined your google api key
                ...
                array(
                    ...
                    'type'     => 'section',
                    'title'    => esc_html__( 'Custom Background', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Define Custom Background for maintenance page.', 'mascot-core-digicod' ),
                    'indent'   => true, // Indent all options below until the next 'section' option is set.
                    'required' => array( 'maintenance-mode-settings-status', '=', '1' ),
                ),
                array(
                ...
                array(
                    ...
                    'type'     => 'switch',
                    'title'    => esc_html__( 'Add Background Overlay', 'mascot-core-digicod' ),
                    'subtitle' => '',
                    'default'  => 0,
                    'on'       => esc_html__( 'Yes', 'mascot-core-digicod' ),
                    'off'      => esc_html__( 'No', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'          => 'slider',
                    'title'         => esc_html__( 'Background Overlay Opacity', 'mascot-core-digicod' ),
                    'subtitle'      => esc_html__( 'Overlay on background image on footer.', 'mascot-core-digicod' ),
                    'desc'          => '',
                    'default'       => 7,
                    'min'           => 1,
                    'step'          => 1,
                ...
                array(
                    ...
                    'type'     => 'button_set',
                    'compiler' =>true,
                    'title'    => esc_html__( 'Background Overlay Color', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Select Dark or White Overlay on background image.', 'mascot-core-digicod' ),
                    'options'  => array(
                        'dark'          => esc_html__( 'Dark', 'mascot-core-digicod' ),
                        'white'         => esc_html__( 'White', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'     => 'section',
                    'title'    => esc_html__( 'Countdown Timer', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Define time and styles for Countdown Timer.', 'mascot-core-digicod' ),
                    'indent'   => true, // Indent all options below until the next 'section' option is set.
                    'required' => array( 'maintenance-mode-settings-status', '=', '1' ),
                ),
                array(
                    ...
                    'type'     => 'switch',
                    'title'    => esc_html__( 'Enable Countdown Timer', 'mascot-core-digicod' ),
                    'subtitle' => '',
                    'default'  => 0,
                    'on'       => esc_html__( 'Yes', 'mascot-core-digicod' ),
                    'off'      => esc_html__( 'No', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'     => 'date',
                    'title'    => esc_html__( 'Launch Date', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Enter the date when your website will be launched. The countdown will count to that day.', 'mascot-core-digicod' ),
                    'desc'     => '',
                ...
                array(
                    ...
                    'type'          => 'slider',
                    'title'         => esc_html__( 'Launch Hour', 'mascot-core-digicod' ),
                    'subtitle'      => esc_html__( 'Choose launcing hour in between 0 to 23 (24 hour format).', 'mascot-core-digicod' ),
                    'desc'          => '',
                    'default'       => 7,
                    'min'           => 0,
                    'step'          => 1,
                ...
                array(
                    ...
                    'type'          => 'slider',
                    'title'         => esc_html__( 'Launch Minute', 'mascot-core-digicod' ),
                    'subtitle'      => esc_html__( 'Choose launcing Minute in between 0 to 59.', 'mascot-core-digicod' ),
                    'desc'          => '',
                    'default'       => 30,
                    'min'           => 0,
                    'step'          => 1,
                ...
                array(
                    ...
                    'type'     => 'button_set',
                    'title'    => esc_html__( 'Countdown Timer Style', 'mascot-core-digicod' ),
                    'subtitle' => esc_html__( 'Choose one from different styles', 'mascot-core-digicod' ),
                    'desc'     => '',
                    'options'  => array(
                ...
                array(
                    ...
                    'type'     => 'textarea',
                    'title'    => esc_html__( 'Date Time Format', 'mascot-core-digicod' ),
                ...
                array(
                    ...
                    'type'          => 'typography',
                    'title'         => esc_html__( 'Countdown Timer Typography', 'mascot-core-digicod' ),
                    'subtitle'      => '',
                    //'compiler'    => true,  // Use if you want to hook in your own CSS compiler
                    'google'        => true,
                    // Disable google fonts. Won't work if you haven't defined your google api key
    ...
    if ( ! mascot_core_digicod_theme_installed() ) {
        Redux::setSection( $opt_name, mascot_core_digicod_redux_opt_maintenance_section() );
    }