<?php
namespace MascotCoreDigicod\Widgets\Products_Category\Skins;
...
class Skin_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Current Theme5', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls1( Widget_Base $widget ) {
		...
		$this->add_control(
			'leaf_image',
			[
				'label' => esc_html__( "Leaf Image", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "Upload the Leaf image", 'mascot-core-digicod' ),
			]
		);
		...
		$this->start_controls_section(
			'current_style',
			[
				'label' => esc_html__('Color Options (Current Theme Skin4)', 'mascot-core-digicod'),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Wrapper Border Color', 'mascot-core-digicod'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Wrapper Border Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Counter Color Options (Current Theme Skin4)', 'mascot-core-digicod'),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Count Value Color', 'mascot-core-digicod'),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Count Value Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
				...
				<div class="content-wrapper">
					<div class="content-inner" data-text="<?php echo empty($settings['categories_name']) ? esc_html($category->name) : $settings['categories_name']; ?>">
						<div class="cat-image">
							...
							<img src="<?php $image = wp_get_attachment_image_src( $settings['skin_current_theme5_leaf_image']['id'], 'full'); echo esc_url( $image[0] );?>" alt="<?php esc_attr_e( 'Image', 'mascot-core-digicod'); ?>">
							<?php endif; ?>
