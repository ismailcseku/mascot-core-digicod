<?php
namespace MascotCoreDigicod\Widgets\Product_List;
...
class TM_Elementor_Product_List extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-product-list', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/woo/product-list/product-list-loader' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Product List', 'mascot-core-digicod' );
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Price Amount Styling', 'mascot-core-digicod' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'list_border',
                'label' => esc_html__( 'List Border', 'mascot-core-digicod' ),
        ...
        $this->start_controls_section(
            'last_item_options',
            [
                'label' => esc_html__( 'Last Child Styling', 'mascot-core-digicod' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_responsive_control(
            'last_item_margin',
            [
                'label' => esc_html__( 'Item Margin', 'mascot-core-digicod' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'last_item_padding',
            [
                'label' => esc_html__( 'Item Padding', 'mascot-core-digicod' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
