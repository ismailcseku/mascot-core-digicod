...
class TM_Elementor_InfoBanner extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-info-banner-advanced-style', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/woo/info-banner-advanced/info-banner-advanced' . $direction_suffix . '.css' );
		wp_register_script( 'tm-info-banner-advanced-script', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/js/woo/info-banner.js' );
	}
	...
	*/
	public function get_title() {
		return esc_html__( 'Info Banner', 'mascot-core-digicod' );
	}
  	...
  	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'layout-top-reveal' => esc_html__( 'Top Reveal', 'mascot-core-digicod' ),
					'layout-center'  => esc_html__( 'Center Standard', 'mascot-core-digicod' ),
					'layout-bottom'  => esc_html__( 'From Bottom', 'mascot-core-digicod' ),
					'layout-image-switch'  => esc_html__( 'Image Switch', 'mascot-core-digicod' ),
					'layout-basic'  => esc_html__( 'Basic', 'mascot-core-digicod' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Example title", 'mascot-core-digicod' ),
			]
		);
		$this->add_control(
			'title_tag',
		...
		$this->add_control(
			'show_subtitle', [
				'label' => esc_html__( "Show Sub Title", 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "Example subtitle", 'mascot-core-digicod' ),
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Sub Title Vertical Alignment", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_disply_flex_vertical_align_elementor(),
				'default' => '',
				'selectors' => [
		...
		$repeater->add_control(
			'subtitle_other_text',
			[
				'label' => esc_html__( "Subtitle Text", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Theme Colored", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			'subtitle_list',
			[
				'label' => esc_html__( "Subtitle Other Parts", 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			'paragraph_opt',
			[
				'label' => esc_html__( 'Content - Paragraph', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Write a short description", 'mascot-core-digicod' ),
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Image/Color', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Overlay', 'mascot-core-digicod' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Floating PNG Image', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating PNG Image (Hover)", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating Image Size", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				...
				"description" => esc_html__( "Put custom width of the uploaded image in positive value. Example: 120px", 'mascot-core-digicod' ),
				'range' => [
					'px' => [
						'min' => 0,
						'max' => 1200,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Position Options', 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Subtitle Options', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Paragraph Options', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Hover Crystal Animation Effect", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'hover-linear-crystal-animation' => esc_html__( 'Linear Crystal Animation', 'mascot-core-digicod' ),
					'hover-cross-crystal-animation' => esc_html__( 'Cross/Plus Crystal Animation', 'mascot-core-digicod' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Enable Background Zoom Effect', 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Circle Animation', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Circle Background Color', 'mascot-core-digicod'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Circle Opacity', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Inner Border Around Wrapper', 'mascot-core-digicod' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Inner Border Around Wrapper', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'link',
			[
				'label' => esc_html__( "Button Link URL", 'mascot-core-digicod' ),
		...
		$this->add_control(
			'link_subtitle',
			[
				'label' => esc_html__( "Link to Subtitle?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$this->add_control(
			'link_title',
			[
				'label' => esc_html__( "Link to Title?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		$this->start_controls_section(
			'button_options',
			[
				'label' => esc_html__( 'Button', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'link_icon_title',
			[
				'label' => esc_html__( "Link Icon, Title and Button?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		$this->start_controls_section(
			'button_icon_options', [
				'label' => esc_html__( 'Button Icon', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'add_btnicon_left',
			[
				'label' => esc_html__( "Show Button Icon Left?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		$this->add_control(
			'button_icon_left',
			[
				'label' => esc_html__( 'Icon Left', 'mascot-core-digicod' ),
		...
		$this->add_control(
			'add_btnicon_right',
			[
				'label' => esc_html__( "Show Button Icon Right?", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		$this->add_control(
			'button_icon_right',
			[
				'label' => esc_html__( 'Icon Right', 'mascot-core-digicod' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'default' => [
					'value' => 'fas fa-chevron-right',
		...
		$this->add_responsive_control(
			'btn_icon_font_size',
			[
				'label' => esc_html__('Font Size', 'mascot-core-digicod'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Around Wrapper', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner Wrapper Style', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Wrapper Height", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
	...
	*/
	protected function render() {
		...
		$html = mascot_core_digicod_get_shortcode_shop_template_part( 'info-banner', $settings['layout'], 'info-banner/tpl', $settings, true );
