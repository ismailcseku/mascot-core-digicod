...
class TM_Elementor_Product_Tabs extends Widget_Base {
	public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-product-tabs', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/woo/product-tabs' . $direction_suffix . '.css' );
		wp_register_script( 'tm-product-tabs', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/js/woo/product-tabs' . $direction_suffix . '.js' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Product Tabs', 'mascot-core-digicod' );
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_setting',
            [
                'label' => esc_html__('Settings', 'mascot-core-digicod'),
        ...
        $this->add_control(
            'style_list',
            [
                'label'     => esc_html__('List Style', 'mascot-core-digicod'),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'default'   => 1,
                'options'   => [
                    1 => esc_html__('Style 1', 'mascot-core-digicod'),
                    2 => esc_html__('Style 2', 'mascot-core-digicod'),
                ],
            ]
        );
        $this->add_responsive_control(
            'column',
            [
                'label'          => esc_html__('columns', 'mascot-core-digicod'),
                'type'           => \Elementor\Controls_Manager::SELECT,
                'default'        => 3,
        ...
        $this->add_control(
            'image_size',
            [
                'label' => esc_html__( "Choose Image Size", 'mascot-core-digicod' ),
                'type' => \Elementor\Controls_Manager::SELECT,
        ...
        $options_product_type = [
            'recent_products'      => esc_html__( 'Recent products', 'mascot-core-digicod' ),
            'featured_products'    => esc_html__( 'Featured Products', 'mascot-core-digicod' ),
            'top_rated_products'   => esc_html__( 'Top Rated Products', 'mascot-core-digicod' ),
            'sale_products'        => esc_html__( 'Products on Sale', 'mascot-core-digicod' ),
            'best_selling_products'=> esc_html__( 'Best Selling Products', 'mascot-core-digicod' )
        ];

        if (mascot_core_digicod_is_elementor_pro_activated()) {
            $options_product_type['ids'] = esc_html__('Product Ids', 'mascot-core-digicod');
        }
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label'       => esc_html__('Tab Title', 'mascot-core-digicod'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('#Product Tab', 'mascot-core-digicod'),
                'placeholder' => esc_html__('Product Tab Title', 'mascot-core-digicod'),
            ]
        );
        $repeater->add_control(
            'product_type',
            [
                'label'   => esc_html__('Product Type', 'mascot-core-digicod'),
                'type'    => \Elementor\Controls_Manager::SELECT,
        ...
        if (mascot_core_digicod_is_elementor_pro_activated()) {
            $repeater->add_control(
                'product_ids',
                [
                    'label'        => esc_html__('Product ids', 'mascot-core-digicod'),
        ...
        $repeater->add_control(
            'limit',
            [
                'label'   => esc_html__('Posts Per Page', 'mascot-core-digicod'),
        ...
        $repeater->add_control(
            'advanced',
            [
                'label'     => esc_html__('Advanced', 'mascot-core-digicod'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    'id'         => esc_html__('Post ID', 'mascot-core-digicod'),
                    'menu_order' => esc_html__('Menu Order', 'mascot-core-digicod'),
                    'popularity' => esc_html__('Number of purchases', 'mascot-core-digicod'),
                    'rating'     => esc_html__('Average Product Rating', 'mascot-core-digicod'),
                    'title'      => esc_html__('Product Title', 'mascot-core-digicod'),
                    'rand'       => esc_html__('Random', 'mascot-core-digicod'),
                ],
                'condition' => [
                    'product_type!' => 'ids'
                ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'   => 'desc',
                'options'   => [
                    'asc'  => esc_html__('ASC', 'mascot-core-digicod'),
                    'desc' => esc_html__('DESC', 'mascot-core-digicod'),
                ],
                'condition' => [
                    'product_type!' => 'ids'
                ]
        ...
        $repeater->add_control(
            'categories',
            [
                'label'       => esc_html__('Categories', 'mascot-core-digicod'),
        ...
        $repeater->add_control(
            'cat_operator',
            [
                'label'     => esc_html__('Category Operator', 'mascot-core-digicod'),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'default'   => 'IN',
                'options'   => [
                    'AND'    => esc_html__('AND', 'mascot-core-digicod'),
                    'IN'     => esc_html__('IN', 'mascot-core-digicod'),
                    'NOT IN' => esc_html__('NOT IN', 'mascot-core-digicod'),
                ],
                'condition' => [
                    'categories!' => ''
                ],
        ...
        $repeater->add_control(
            'tag',
            [
                'label'       => esc_html__('Tags', 'mascot-core-digicod'),
                'type'        => \Elementor\Controls_Manager::SELECT2,
                'label_block' => true,
        ...
        $repeater->add_control(
            'tag_operator',
            [
                'label'     => esc_html__('Tag Operator', 'mascot-core-digicod'),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'default'   => 'IN',
                'options'   => [
                    'AND'    => esc_html__('AND', 'mascot-core-digicod'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'tab_title' => esc_html__('Tab 1', 'mascot-core-digicod'),
                    ],
                    [
                        'tab_title' => esc_html__('Tab 2', 'mascot-core-digicod'),
                    ]
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Tab Wrapper', 'mascot-core-digicod'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Wrapper Background Color', 'mascot-core-digicod'),
        ...
        $this->add_responsive_control(
            'align_items',
            [
                'label'        => esc_html__('Tab Align', 'mascot-core-digicod'),
        ...
        $this->add_responsive_control(
            'header_margin',
            [
                'label'      => esc_html__('Tab Margin', 'mascot-core-digicod'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__('Each Tab Styling', 'mascot-core-digicod'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'tab_title_spacing',
            [
                'label'      => esc_html__('Horizontal Padding', 'mascot-core-digicod'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Vertical Padding', 'mascot-core-digicod'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab(
            'tab_title_active',
            [
                'label' => esc_html__('Active', 'mascot-core-digicod'),
            ]
        );
    ...
    protected function add_control_carousel($condition = array()) {
        ...
        $this->add_control(
            'enable_carousel',
            [
                'label' => esc_html__('Enable', 'mascot-core-digicod'),
        ...
        $this->add_control(
            'navigation',
            [
                'label'     => esc_html__('Navigation', 'mascot-core-digicod'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'dots',
                'options'   => [
                    'both'   => esc_html__('Arrows and Dots', 'mascot-core-digicod'),
                    'arrows' => esc_html__('Arrows', 'mascot-core-digicod'),
                    'dots'   => esc_html__('Dots', 'mascot-core-digicod'),
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'     => esc_html__('Pause on Hover', 'mascot-core-digicod'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label'     => esc_html__('Autoplay Speed', 'mascot-core-digicod'),
        ...
        $this->add_control(
            'infinite',
            [
                'label'     => esc_html__('Infinite Loop', 'mascot-core-digicod'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->start_controls_section(
            'carousel_arrows',
            [
                'label'      => esc_html__('Carousel Arrows', 'mascot-core-digicod'),
                'conditions' => [
                    'relation' => 'and',
                    'terms'    => [
                        [
        ...
        $this->add_control(
            'next_heading',
            [
                'label' => esc_html__('Next button', 'mascot-core-digicod'),
        ...
        $this->add_control(
            'next_vertical',
            [
                'label'       => esc_html__('Next Vertical', 'mascot-core-digicod'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'top'    => [
                        'title' => esc_html__('Top', 'mascot-core-digicod'),
                        'icon'  => 'eicon-v-align-top',
                    ],
                    'bottom' => [
                        'title' => esc_html__('Bottom', 'mascot-core-digicod'),
        ...
        $this->add_control(
            'next_horizontal',
            [
                'label'       => esc_html__('Next Horizontal', 'mascot-core-digicod'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
        ...
        $this->add_control(
            'prev_heading',
            [
                'label'     => esc_html__('Prev button', 'mascot-core-digicod'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control(
            'prev_vertical',
            [
                'label'       => esc_html__('Prev Vertical', 'mascot-core-digicod'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'top'    => [
        ...
        $this->add_control(
            'prev_horizontal',
            [
                'label'       => esc_html__('Prev Horizontal', 'mascot-core-digicod'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
    ...
    private function woocommerce_default($settings, $global_setting) {
        ...
        $html = mascot_core_digicod_get_shortcode_shop_template_part( 'product-tabs', null, 'product-tabs/tpl', $settings, true );
