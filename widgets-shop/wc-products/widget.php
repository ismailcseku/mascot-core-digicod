<?php
namespace MascotCoreDigicod\Widgets\Products;
...
class TM_Elementor_WC_Products extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'tm-countdown-script', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/js/widgets/countdown.js' );

		wp_register_style( 'tm-wc-products', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/woo/wc-products/wc-products-loader' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'WC(Woocommerce) Products', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'padding-topbottom',
			[
				'label' => esc_html__( "Padding Top Bottom", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->add_control(
			'padding-leftright',
			[
				'label' => esc_html__( "Padding Left Right", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->start_controls_section(
			'loadmore_button_options', [
				'label' => esc_html__( 'Loadmore Button Options', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		mascot_core_get_viewdetails_button_arraylist($this, 1,  esc_html__( "Load More", 'mascot-core-digicod' ), 'loadmore_');
		mascot_core_get_viewdetails_button_arraylist($this, 2,  esc_html__( "Load More", 'mascot-core-digicod' ), 'loadmore_');
	...
	public function wc_render_output( $class_instance, $settings ) {
		...
		$html = mascot_core_digicod_get_shortcode_shop_template_part( 'wc-products', $settings['display_type'], 'wc-products/tpl', $settings, true );
