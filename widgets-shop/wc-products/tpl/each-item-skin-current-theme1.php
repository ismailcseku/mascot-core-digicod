    ...
    <div class="product-inner">
        ...
        <div class="content-box">
            ...
            echo apply_filters( 'woocommerce_loop_add_to_cart_link',
             ...
             $product );
            ?>
            <?php digicod_woocommerce_time_sale_layout_2(); ?>
        </div>
    </div>
</div>
