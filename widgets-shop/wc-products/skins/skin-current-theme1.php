<?php
namespace MascotCoreDigicod\Widgets\Products\Skins;
...
class Skin_Current_Theme1 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/tm-ele-wc-products/general/after_section_end', [ $this, 'register_layout_controls1' ] );
	}
