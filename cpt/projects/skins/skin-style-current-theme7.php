...
class Skin_Style_Current_Theme7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme7', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme7:hover .inner-box .info-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme7:hover .inner-box .info-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme7', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/projects/project-skin-current-theme7' . $direction_suffix . '.css' );
