		...
		$this->parent = $widget;
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme9 .info-box' => 'background-color: {{VALUE}};'
						]
					]
				);
				$this->add_control(
				...
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme9 .info-box .icon' => 'color: {{VALUE}};'
						]
					]
				);
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme9 .info-box .icon' => 'background-color: {{VALUE}};'
						]
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme9 .info-box:hover' => 'background-color: {{VALUE}};'
						]
					]
				);
				$this->add_control(
				...
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme9 .info-box:hover .icon' => 'color: {{VALUE}};'
						]
					]
				);
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme9 .info-box:hover .icon' => 'background-color: {{VALUE}};'
						]
					]
				);
				$this->end_controls_tab();
