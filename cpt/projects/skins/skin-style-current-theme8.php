		...
		$this->parent = $widget;
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme8 .info-box' => 'background-color: {{VALUE}};'
						]
					]
				);
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Icon Options', 'mascot-core-digicod' ),
						'type' => \Elementor\Controls_Manager::HEADING,
					]
				);
				$this->add_responsive_control(
					...
					[
						'label' => esc_html__( "Custom Icon Color", 'mascot-core-digicod' ),
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme8 .info-box .read-more' => 'color: {{VALUE}};'
						]
					]
				);
				$this->add_responsive_control(
					...
					[
						'label' => esc_html__( "Custom Icon Bg Color", 'mascot-core-digicod' ),
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme8 .info-box .read-more' => 'background-color: {{VALUE}};'
						]
					]
				);
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Background Options (Hover)', 'mascot-core-digicod' ),
						'type' => \Elementor\Controls_Manager::HEADING,
					]
				);
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme8 .inner-box:hover .info-box' => 'background-color: {{VALUE}};'
						]
					]
				);
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Icon Options (Hover)', 'mascot-core-digicod' ),
						'type' => \Elementor\Controls_Manager::HEADING,
					]
				);
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme8 .inner-box:hover .read-more' => 'color: {{VALUE}};'
						]
					]
				);
				$this->add_responsive_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .projects-current-theme8 .inner-box:hover .read-more' => 'background-color: {{VALUE}};'
						]
					]
				);
				$this->end_controls_tab();
