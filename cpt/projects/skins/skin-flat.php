...
class Skin_Flat extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Flat', 'mascot-core-digicod' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-flat', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/projects/project-skin-flat' . $direction_suffix . '.css' );
