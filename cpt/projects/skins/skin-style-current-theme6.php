...
class Skin_Style_Current_Theme6 extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-style-current-theme6';
	}


	public function get_title() {
		return __( 'Skin - Style Current Theme6', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme6:hover .inner-box .info-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme6:hover .inner-box .info-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme6', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/projects/project-skin-current-theme6' . $direction_suffix . '.css' );
