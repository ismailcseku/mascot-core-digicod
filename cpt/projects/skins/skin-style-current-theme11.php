...
class Skin_Style_Current_Theme11 extends Elementor_Skin_Base {
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme11', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/projects/project-skin-current-theme11' . $direction_suffix . '.css' );
