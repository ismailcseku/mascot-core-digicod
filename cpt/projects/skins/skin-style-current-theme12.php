...
class Skin_Style_Current_Theme12 extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-style-current-theme12';
	}


	public function get_title() {
		return __( 'Skin - Style Current Theme12', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .content-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .content-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .inner-box:hover .content-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .inner-box:hover .content-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .read-more' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .read-more' => 'color: {{VALUE}};'
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .read-more:hover' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .projects-current-theme12 .read-more:hover' => 'color: {{VALUE}};'
				],
			]
		);
		$this->end_controls_tab();
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme12', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/projects/project-skin-current-theme12' . $direction_suffix . '.css' );
