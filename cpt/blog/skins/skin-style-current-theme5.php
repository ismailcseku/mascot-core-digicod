...
class Skin_Style_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme5', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/blog/blog-skin-style-current-theme5' . $direction_suffix . '.css' );
