...
class Skin_Vertical_List extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Style - Vertical List', 'mascot-core-digicod' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'vertical_list-options', [
				'label' => esc_html__( 'Vertical List Options', 'mascot-core-digicod' ),
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-blog-skin-vertical-list', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/blog/blog-skin-vertical-list' . $direction_suffix . '.css' );
		...
		$html = mascot_core_digicod_get_cpt_shortcode_template_part( 'blog', $settings['_skin'], 'blog/tpl/design-style', $settings, true );
