...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme3', 'mascot-core-digicod' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme3', MASCOT_CORE_DIGICOD_URL_PATH . 'assets/css/cpt/blog/blog-skin-style-current-theme3' . $direction_suffix . '.css' );
