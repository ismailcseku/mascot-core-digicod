<?php
namespace MascotCoreDigicod\Widgets\Blog;
...
class TM_Elementor_Blog extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog/News Grid', 'mascot-core-digicod' );
	}
	...
	protected function register_controls() {
		$posts_array = mascot_core_digicod_get_post_list_array_by_post_type( 'post' );
		$orderby_parameters_list1 = mascot_core_digicod_orderby_parameters_list();
		...
		$this->add_control(
			'display_type', [
				...
				'options' => [
					...
					'masonry-tiles' =>  esc_html__( 'Masonry Tiles', 'mascot-core-digicod' ),
					'carousel' =>  esc_html__( 'Carousel', 'mascot-core-digicod' ),
					'basic' =>  esc_html__( 'Basic', 'mascot-core-digicod' ),
					'floating-parallax'  =>  esc_html__( 'Floating Parallax', 'mascot-core-digicod' )
				],
				'default' => 'grid'
			]
		);
		...
		$this->add_control(
			'use_masonry_tiles_featured_image_size', [
				'label' => esc_html__( "Use Predefined Image Size in Masonry Mode", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				"description" => esc_html__( "You can select predefined image size from each items edit page. If you choose yes, then 'Featured Image Size' will not work", 'mascot-core-digicod' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->start_controls_section(
			'content',
			[
				'label' => esc_html__( 'All Items(Content) Show/Hide', 'mascot-core-digicod' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'show_featured_image', [
				'label' => esc_html__( "Show Featured Image", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'excerpt_length', [
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Number of words to display", 'mascot-core-digicod' ),
				'condition' => [
		...
		$this->add_control(
			'post_meta_options',
			[
				'label' => esc_html__( "Choose Post Meta", 'mascot-core-digicod' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Show This Meta Over Thumbnail", 'mascot-core-digicod' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => $post_meta_array,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Single Meta Styling', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper Styling', 'mascot-core-digicod' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
